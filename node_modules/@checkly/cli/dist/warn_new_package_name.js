...
const hook = async function (options) {
    console.log(`${chalk.bold.yellow('> The Checkly CLI has moved to a new package name')}: https://www.npmjs.com/package/checkly.` +
        chalk.dim(`
...
//# sourceMappingURL=warn_new_package_name.js.map